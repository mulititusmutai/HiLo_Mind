...
def get_astar_path(nodes_dict, start_node, goal_node):
    def heuristic(a, b):
...
class DFSExplorer:
    ...
    def _backtrack_via_astar(self):
        ...
        if frontiers:
            ...
            path = get_astar_path(self._grid_nodes, self._current, target_junction)
...
class Tree:
    ...
    def _handle_exploration_complete(self):
        if self.mission_phase == "exploring":
            path = get_astar_path(self.grid._nodes, self._at_node, self.grid.start)
            if path:
            ...
            path = get_astar_path(self.grid._nodes, self._at_node, self.goal_node)
            if path:
...
def main():
    ...
    map_a = [      
             ...
             ((1,0), (1,1)), ((1,3), (1,5)), ((2,2), (2,3)), ((3,1), (3,4)), ((4,1), (4,2)), ((4,4), (4,5)), ((5,2), (5,4)),
             ((2,1), (3,1)), ((4,1), (6,1)), ((1,2), (2,2)), ((1,3), (2,3)), ((3,3), (5,3)), ((2,4), (3,4)), ((2,5), (5,5))
    ]
    ...
    map_c = [[[6, 3], [9, 3]], [[3, 3], [3, 5]], [[4, 7], [5, 7]], [[6, 5], [6, 8]], [[5, 4], [5, 5]], [[2, 9], [4, 9]], [[10, 2], [10, 10]],
             [[6, 2], [6, 4]], [[5, 6], [6, 6]], [[2, 10], [10, 10]], [[8, 9], [9, 9]], [[3, 8], [8, 8]], [[7, 7], [10, 7]], [[4, 4], [6, 4]],
             [[5, 8], [5, 9]], [[6, 9], [6, 10]], [[9, 6], [9, 9]], [[8, 3], [8, 5]], [[4, 4], [4, 8]], [[8, 5], [9, 5]], [[7, 4], [7, 7]],
             [[3, 3], [5, 3]], [[2, 2], [10, 2]], [[9, 4], [10, 4]], [[5, 2], [5, 3]], [[7, 6], [8, 6]], [[6, 9], [7, 9]], [[2, 2], [2, 10]],
             [[3, 6], [4, 6]], [[2, 7], [3, 7]]
    ]
    spacing, sx, sy = 90, 2, 3
    maze_lines = build_synced_maze(sim, map_a, spacing)
    ...
    tree = Tree(grid, player, goal_grid_pos=(4, 3))
